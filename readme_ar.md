...
<p align="center">اعجبك المشروع ؟ رجائا قم<a href="https://www.paypal.me/anuraghazra"> بالتبرع</a> لتحسين المشروع 
...
---
تم حساب القيم عن طريق [دالة التوزيع التراكمي](https://en.wikipedia.org/wiki/Cumulative_distribution_function) باستخدام الالتزامات , المساهمات, المشاكل, النجوم, طلب الغيير, المتابعين, المشاريع المملوكة.
...
<details>
 <summary><b> دليل لتثبيت سيرفر الفيرسل  🔨 </b></summary>

1. اذهب الى [vercel.com](https://vercel.com/)
1. اضغط على `Log in`
   ![](https://files.catbox.moe/tct1wg.png)
1. سجل عن طريق حساب الكيت-هاب عن طريق الضغط على `Continue with GitHub`
   ![](https://files.catbox.moe/btd78j.jpeg)
1. سجل بالكيت-هاب و اعطه تصريح للوصول لجميع المشاريع 
1. قم بربط هذا المشروع
1. عد الى [Vercel dashboard](https://vercel.com/dashboard)
1. اختر `Import Project`
   ![](https://files.catbox.moe/qckos0.png)
1. اختر `Import Git Repository`
   ![](https://files.catbox.moe/pqub9q.png)
1. حدد الجذر واحتفظ بكل شيء كما هو ، فقط أضف متغير البيئة المسمى PAT_1 (كما هو موضح) ، والذي سيحتوي على رمز وصول شخصي (PAT) ، والذي يمكنك إنشاؤه بسهولة [هنا](https://github.com/settings/tokens/new) (leave everything as is, just name it something, it can be anything you want)
   ![](https://files.catbox.moe/0ez4g7.png)
1. اضغط على Deploy و هذا هو كل شيء على ما يرام الان

</details>

## :sparkling_heart: ادعم المشروع
